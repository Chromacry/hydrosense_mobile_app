    ...
    void logoutHandler() {
      authService.logOut().then((value) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
            StatusSnackbar.snackbarStatus(textMessage: 'Logout Successfully!'));
                ...
                return snapshot.connectionState == ConnectionState.waiting
                    ...
                    : Column(
                        children: <Widget>[
                                ...
                                Positioned(
                                  ...
                                  child: CircleAvatar(
                                      ...
                                      child: (snapshot.hasData &&
                                              snapshot.data != null)
                                          ? snapshot.data!.profile_photo == null
                                              ? FittedBox(
                                                  fit: BoxFit.cover,
                                                  child: Image.network(
                          ...
                          Text(
                            snapshot.data?.email_address.toString() ??
                                user!.email.toString(),
                            style: TextStyle(
                              color: Colors.white,
                              fontSize: 14,
                                ...
                                Row(
                                  ...
                                  children: [
                                    Text(
                                      'Role',
                                      style:
                                          MoreMenuStyles.accountInfoDataTitle,
                                    ),
                                    Text(
                                      snapshot.data?.role_id.toString() ??
                                          'Demo User',
                                      style:
                                          MoreMenuStyles.accountInfoDataTitle,
                                    ),
                          ...
                          Container(
                            ...
                            child: Text('More Menu',
                                style: MoreMenuStyles.moreMenuTitle),
                          ),
                          //* More Menu Box
                          Container(
                            height: 215,
                          ...
                          Container(
                            ...
                            child: Text('Preferences',
                                style: MoreMenuStyles.preferencesTitle),
                          ),
                          //* Preferences Box
                          Container(
                            margin: EdgeInsets.only(bottom: 50),
                            ...
                            child: Column(
                              children: [
                                PreferencesSwitch(
                                  title: 'Dark Mode',
                                  titleStyle:
                                      MoreMenuStyles.preferencesDataTitle,
                                  onToggle: (value) =>
